...
public class FollowCamera : MonoBehaviour {
	...
	// Otras Variables que se usan para   el juego 


	public 	GameObject Dado;
	//public  bool LanzarDado=true;
	//private int cantCasillas=32;
    ...
    void Start ()
    {
		...
		Dado = GameObject.Find("d6");
		Boton = GameObject.Find("LanzarDado");
